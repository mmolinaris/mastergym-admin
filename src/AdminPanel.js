...
function printCredenziali(cliente) {
  ...
  <style>
    ...
    * { box-sizing:border-box; margin:0; padding:0; }
    body { font-family:'Sora',sans-serif; background:#fff; display:flex; align-items:center; justify-content:center; min-height:100vh; }
    ...
    .header-text .name { font-size:16px; font-weight:900; color:#fff; }
    .header-text .sub { font-size:11px; color:rgba(255,255,255,0.8); }
    .body { padding:20px; }
    .welcome { font-size:18px; font-weight:900; color:#111; margin-bottom:4px; }
    .welcome-sub { font-size:12px; color:#888; margin-bottom:16px; }
    ...
    .cred-label { font-size:10px; font-weight:700; color:#FF6B00; letter-spacing:1px; margin-bottom:6px; }
    .cred-value { font-size:22px; font-weight:900; color:#111; letter-spacing:2px; border:2px dashed #FF6B00; border-radius:8px; padding:8px; }
    .cred-divider { width:1px; background:#FFD4B0; }
    .steps { margin-bottom:14px; }
    .step { display:flex; align-items:flex-start; gap:8px; margin-bottom:8px; }
    .step-num { width:20px; height:20px; border-radius:6px; background:#FF6B00; color:#fff; font-size:11px; font-weight:900; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
    .step-text { font-size:11px; color:#444; line-height:1.4; }
    .step-text b { color:#FF6B00; }
    ...
    .bottom-text .url { font-size:13px; font-weight:800; color:#FF6B00; }
    .bottom-text .note { font-size:10px; color:#999; margin-top:4px; }
  ...
  <div class="card">
    <div class="header">
      ...
      <div class="header-text">
        <div class="name">ASD Master Gym</div>
        <div class="sub">Via Bussinello, 73 · Canelli (AT)</div>
      </div>
    </div>
    <div class="body">
      <div class="welcome">Benvenuto/a ${cliente.nome}! 💪</div>
      <div class="welcome-sub">Le tue credenziali per accedere alla scheda</div>
      <div class="creds">
        <div class="cred">
          <div class="cred-label">CODICE CLIENTE</div>
          <div class="cred-value">${cliente.codice}</div>
        </div>
        <div class="cred-divider"></div>
        <div class="cred">
          <div class="cred-label">PIN SEGRETO</div>
          <div class="cred-value">${cliente.pin}</div>
        </div>
      </div>
      <div class="steps">
        <div class="step"><div class="step-num">1</div><div class="step-text">Inquadra il QR oppure vai su <b>mastergymcanelli.vercel.app</b></div></div>
        <div class="step"><div class="step-num">2</div><div class="step-text">Inserisci il tuo <b>Codice</b> e il tuo <b>PIN</b></div></div>
        <div class="step"><div class="step-num">3</div><div class="step-text"><b>iPhone:</b> Condividi → Aggiungi a Home &nbsp;|&nbsp; <b>Android:</b> Menu → Aggiungi a Home</div></div>
      </div>
      <div class="bottom">
        <img src="${qr}" alt="QR">
        <div class="bottom-text">
          <div class="url">mastergymcanelli.vercel.app</div>
          <div class="note">Per assistenza parla con il tuo trainer</div>
        </div>
      </div>
    </div>
  </div></body></html>`;
